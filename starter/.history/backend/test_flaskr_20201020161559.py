...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create quiz object with empty category (to test POST /questions)
        self.new_quiz = {
            'quiz_category': {'type': 'Science', 'id': 1},
            'previous_questions': []
        }
    ...
    # TEST: GET /categories/1/questions
    ...
    # TEST: POST /quizzes (422: Unprocessable)
    def test_422_if_empty_quiz_category(self):
        # Store the response in the 'res' variable
        res = self.client().post('/quizzes', json={'searchTerm': ''})
        # Load the data using json.loads of the response
        data = json.loads(res.data)
