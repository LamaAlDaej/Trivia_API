...
def create_app(test_config=None):
  ...
  def get_categories():
    ...
    return jsonify({
      'success': True,
      # Use the ListInterpolation to format the categories appropriately
  ...
  def get_questions():
    ...
    return jsonify({
        ...
        'categories': {category.format() for category in categories}, # Use the ListInterpolation to format the categories appropriately
