...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_get_questions_of_category(self):
        ...
        self.assertEqual(data['current_category'], 20)

    # TEST: GET /categories/1000/questions (404: Page is not found)
    ...
    # TEST: POST /quizzes/10 (405: Method not allowed)
    def test_405_if_question_creation_not_allowed(self):
        # Store the response in the 'res' variable
        res = self.client().post('/quizzes/10', json=self.new_question)
        # Load the data using json.loads of the response
        data = json.loads(res.data)
        ...
        # Check the message body
        self.assertEqual(
            data['message'], 'The request method is not supported for the requested resource.')
