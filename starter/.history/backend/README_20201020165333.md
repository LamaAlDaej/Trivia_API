...
- Request Arguments: None
- Returns: An object that contaA list of the current page questions (10 questions per page), number of total questions, list of categories in key:value pairs, and the ID of the current category.
{'1' : "Science",
'2' : "Art",
'3' : "Geography",
'4' : "History",
